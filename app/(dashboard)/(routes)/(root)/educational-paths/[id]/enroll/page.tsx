      ...
      <SignedOut>
        <div className="p-6">
          <div className="max-w-2xl space-y-4">
            <h1 className="text-3xl font-bold text-gray-900">Dokończ zapis na ścieżkę edukacyjną</h1>
            <p className="text-gray-600">
              Zaloguj się lub załóż konto, aby zapisać się na ścieżkę, rozpocząć naukę i śledzić postępy.
            </p>
